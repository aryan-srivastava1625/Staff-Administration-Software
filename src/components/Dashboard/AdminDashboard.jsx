    ...
    <div className='h-screen w-full p-10'>
      ...
      <div className='p-5 bg-[#1C1C1C] mt-7 rounded'>
        <form className='flex flex-wrap w-full  items-start justify-between '>
            ...
            <div className='w-1/2'>
            <div>
            <h3 className='text-sm text-gray-300 mb-0.5'>Name of the Task</h3>
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='Enter the Task Name' />
            </div>
            ...
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='Design etc' />
            </div>
